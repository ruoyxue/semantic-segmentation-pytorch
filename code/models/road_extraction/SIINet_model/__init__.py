# from .HF_FCN import HF_FCN
# from .DeeplabV3_plus import DeeplabV3_plus
# from .ContrastNets import ResUnet, ResUnet_SIIS
from .SIIS_NET import (
    Vgg_SIIS, Resnet_SIIS, Deeplab_SIIS
)
# from .UNet import UNet, UNet_SIIS


def build_model(num_classes, siis_size=None, net_num='12345678', pretrained_flag=True):
    '''
    Args:
    ...
    print('-'*50, '\n', 'Net_num: ', net_num)
    commen_str = model_name[paras[0]] + '(' + str(num_classes)
    ...
    if pretrained_flag:
        commen_str += ', pretrained_flag=True'
    else:
        commen_str += ', pretrained_flag=False'
...
if __name__ == '__main__':
    import torch
    model = build_model(1, net_num='44330040')
