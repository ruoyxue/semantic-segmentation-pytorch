...
from code.lufangxiao.GDA_block import build_sua_wo_spa_rpb_module_vis

class Swin_LinkNet_SUA_wo_vis(nn.Module):
    def __init__(self, num_classes=1, num_channels=3, pretrained=None, backbone='swin-t'):
        super(Swin_LinkNet_SUA_wo_vis, self).__init__()
        ...
        self.SUA = build_sua_wo_spa_rpb_module_vis(filters, '/home/lufangxiao/GDANet/models/GDA_block/module_cfg/default_cfg.yaml')
...
if __name__ == "__main__":
    ...
    net = Swin_LinkNet_SUA_wo_vis(num_classes=17, num_channels=3)
