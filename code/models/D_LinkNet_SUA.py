...
class DLinkNet_SUA(nn.Module):
    def __init__(self, num_classes=1, num_channels=3, backbone='resnet50', pretrained_flag=True):
        ...
        self.name = "DLinkNet_SUA_" + backbone
...
if __name__ == "__main__":
    ...
    net = DLinkNet_SUA(num_classes=17, num_channels=3, backbone='resnet18', pretrained_flag=True)
